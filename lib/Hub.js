...
Hub.prototype.chain = function(func) {
    var argsLen = arguments.length - 1;
    var args = new Array(argsLen);
    var argsIdx = -1;
    while(++argsIdx < argsLen) {
        args[argsIdx] = arguments[argsIdx + 1];
    }
    if(typeof func === "string") {
        func = this[func];
    }
    return this.letBind(function(self) {
...
Hub.prototype = ([
        ...
        var obsName = names[0];
        var evtName = names[1];
        var predicate = Fn.compareField("type", evtName);
        proto[obsName] = function() {
            return this.chain("filter", predicate);
        };
        return proto;
    }, Hub.prototype);
...
Hub.prototype = ([
        ...
        var ackName = names[1];
        var evtName = names[2];
        var predicate = Fn.compareField("command", evtName);
        ...
        if(ackName) {
            proto[ackName] = function( ) {
                return this.Acknowledgements().chain("filter", predicate);
            };
        }
        return proto;
    }, Hub.prototype);
